...
<html lang="en">
    <head>
        ...
        <?php echo javascript("pieChart.js"); ?>
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a style="color:greenyellow" class="nav-link dropdown-toggle" href="http://example.com" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            Manage
                                        </a>
                                        <div class="dropdown-menu navbarDropdown" aria-labelledby="bs-example-navbar-collapse-1">
                                            <ul class="navbarDropdown">
                                                <li><a class="dropdown-item" href="<?php echo site_url('/admin/addMovies') ?>">Add Movies</a></li>
                                                <li><a class="dropdown-item" href="<?php echo site_url('/admin/addEpisodes') ?>">Add Episodes</a></li>
                                                <li><a class="dropdown-item" href="<?php echo site_url('/admin/getCodes') ?>">Codes</a></li>
                                                <li><a class="dropdown-item" href="<?php echo site_url('/admin/generateCodes') ?>">Generate Codes</a></li>
                                                <li><a class="dropdown-item" href="<?php echo site_url('/admin/getRequests') ?>">Requests</a></li>
                                                <li><a class="dropdown-item" href="<?php echo site_url('/admin/getUsers') ?>">All Users</a></li>
                                                <li><a class="dropdown-item" href="<?php echo site_url('/home/app') ?>">App Site</a></li>
                                            </ul>
                                        </div>
                                    </li>                                    
                                </ul>
